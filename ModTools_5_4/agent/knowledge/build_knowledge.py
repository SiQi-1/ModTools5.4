...
def build_entity_schemas():
    ...
    manual_schemas = {
        "Civilizations": {
            ...
            "note": "文明编辑器字段（ModTools5.4内部格式，非原始SQL列名）",
            "fields": [
                {"key": "civilization_name", "label": "文明名称", "field_type": "text", "required": True,
                 "desc": "中文名，如'中华文明'"},
                {"key": "civilization_description", "label": "文明描述", "field_type": "text", "required": True,
                 "desc": "百科中显示的文明描述"},
                {"key": "civilization_adjective", "label": "文明形容词", "field_type": "text", "required": True,
                 "desc": "如'中华的'、'罗马的'"},
                {"key": "description_suffix", "label": "描述后缀", "field_type": "text", "required": False,
                 "desc": "通常为'帝国'，如'中华帝国'"},
                {"key": "level", "label": "文明级别", "field_type": "text", "required": True,
                 ...
                 "default": "CIVILIZATION_LEVEL_FULL_CIV", "desc": "完整文明/城邦/部落/自由城市"},
                ...
                {"key": "city_name_depth", "label": "城市名随机深度", "field_type": "int", "required": False,
                 "default": 10, "desc": "1=严格按序，值越大越随机，建议10-30"},
                {"key": "trait_name", "label": "特质名称", "field_type": "text", "required": True},
                {"key": "trait_description", "label": "特质描述", "field_type": "text", "required": True},
                {"key": "trait_bindings", "label": "特质绑定", "field_type": "array", "required": False,
                 "desc": "绑定其他实体的特质，如特色建筑/单位/区域"},
                {"key": "icon_image_name", "label": "图标名", "field_type": "text", "required": False,
                 "desc": "图标资源名，如ICON_CIVILIZATION_SIQI_X"},
                {"key": "images", "label": "图片数据", "field_type": "object", "required": False,
                 "desc": "图标/画像等图片资源路径映射，{}表示空"},
                {"key": "city_info", "label": "城市名信息", "field_type": "object", "required": False,
                 "desc": "城市名列表，{}表示空"},
                {"key": "citizen_info", "label": "市民名信息", "field_type": "object", "required": False,
                 "desc": "市民名列表，{}表示空"},
                {"key": "start_bias", "label": "起始偏好", "field_type": "object", "required": False,
                 "desc": "地形/资源/河流起始偏好，{}表示无偏好"},
            ],
        },
        "Leaders": {
            "table_name": "Leaders",
